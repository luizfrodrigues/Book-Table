...
for (let item in biblioteca) {
  console.log(`+++ O livro ${biblioteca[item].titulo} é do autor ${biblioteca[item].autor}. +++`)
}

Object.keys(biblioteca).forEach(item =>
  console.log(`-- O livro ${biblioteca[item].titulo} é do autor ${biblioteca[item].autor}. --`)
);

Object.entries(biblioteca).forEach(item =>
  console.log(`O livro ${item[1].titulo} é do autor ${item[1].autor}.`)
);
